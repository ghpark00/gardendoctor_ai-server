...
from ai_server.db import database
from ai_server import schemas
...
from ai_server.chatbot.agent import run_agent
from ai_server.inference.predict import classify_crop, predict_disease
from ai_server.inference.validation import validate_image_content
...
async def diagnose_image_hierarchical(
    ...
    return DiagnosisResult(
        ...
        filename=file.filename,
        confidence=round(confidence, 2),
        disease_info=schemas.DiseaseInfo(**disease_info)
    )
